...
- Add the smallest possible valid HEIC fixtures for decode/write regression tests. Prefer generated 1x1 or 2x2 images with known RGB/RGBA pixels.
...
4. Run at least one successful conversion using a tiny valid HEIC fixture and verify TIFF metadata.
